...
classDiagram
    ...
    Contribution --> "0..1" Entry : percentage of
    ...
    note for LifeAnnuity "En Holding indtil udbetalingsstart, derefter en garanteret livsvarig ydelse. duration og principle er uden betydning."
```
