...
classDiagram
    ...
    note for Holding "Seks varianter: InstalmentPension, LifeAnnuity, OldAgeSavings, ShareSavingsAccount, ShareDepot og SavingsAccount. De adskiller sig ved beskatning på vejen ind, på afkastet og på vejen ud, og ved loft."
