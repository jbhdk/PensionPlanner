...
classDiagram
    ...
    note for Holding "Syv varianter: InstalmentPension, LifeAnnuity, OldAgeSavings, CapitalPension, ShareSavingsAccount, ShareDepot og SavingsAccount. De adskiller sig ved beskatning på vejen ind, på afkastet og på vejen ud, og ved loft. openedOn, payoutAgeOverride og payoutAge() bæres kun af de fire, der er en PensionScheme: en ShareSavingsAccount, en ShareDepot og en SavingsAccount har ingen udbetalingsalder og dermed heller ikke felterne."
