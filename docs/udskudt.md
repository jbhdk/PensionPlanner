...
**Status:** Delvist taget op. [ADR-0050](./adr/0050-foelger-erhvervsophoer-peger-paa-en-navngiven-person-ikke-periodens-udledte-ejer.md) gør "Følger erhvervsophør" personvalgt, uafhængigt af figurens udledte `periodOwner` — det løser den tvetydighed, denne post oprindelig blev noteret for. Udskudt er kun resten: et **fast alderstal**s "hvis alder?" udledes fortsat af figurens struktur (`periodOwner` i `validatePlan.ts` — en post har sin egen `owner`, en overførsel bruger afgiverens, en beholdningskildet indbetaling bruger destinationens, jf. [ADR-0028](./adr/0028-det-beholdningskildede-bidrag-maa-krydse-ejerskellet.md)), og der findes intet felt, hvor brugeren vælger den person direkte.
