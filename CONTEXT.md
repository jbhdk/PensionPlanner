...
Et tidspunkt for en `PersonAge`-forankret periodes endepunkt: enten en fast alder, målt på periodens udledte ejer, eller en eksplicit henvisning til en navngiven persons erhvervsophør — uafhængig af, hvem perioden ellers udledes at tilhøre, jf. [ADR-0050](./docs/adr/0050-foelger-erhvervsophoer-peger-paa-en-navngiven-person-ikke-periodens-udledte-ejer.md). Sat til erhvervsophør følger den navngivne persons `Person.workEndAge`. Erhvervsophørsåret regnes med som `from` og ikke med som `to`: erhvervsophørsåret er det første år uden arbejde, aldrig det sidste med, jf. [ADR-0031](./docs/adr/0031-erhvervsophoersaaret-taeller-med-som-from-og-ikke-med-som-to.md). En fast alder læses ens i begge roller.
