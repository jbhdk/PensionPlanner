...
Kræver [Node](https://nodejs.org) installeret.
...
Åbn den adresse, kommandoen viser, i browseren.

## Dine data

Planen gemmes kun i din egen browser og sendes aldrig til nogen server. Vil du sikre dig mod at miste den, eller flytte den til en anden browser eller maskine, bruger du knappen **Eksporter** til at gemme den som en fil, og **Importer** til at hente den ind igen.
